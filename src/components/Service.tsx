    ...
    return (
        <div id="service-page">
            ...
            <ul className="event-list">
                ...
                <li> 
                    <b data-aos="fade-left"><a className="event" href="https://upchieve.org/volunteer-with-us" target="_blank">UPchieve</a> (Indefinite)</b>
                ...
                <li>
                    <b data-aos="fade-left"><a className="event" href="https://play.freerice.com/profile-login" target="_blank">FREERICE</a> (Indefinite)</b>
                ...
                <li>
                    <b data-aos="fade-left"><a className="event" href="https://www.bemyeyes.com/" target="_blank">Be My Eyes</a> (Indefinite)</b>
